    ...
    public void execute() {
        switch (state){
            ...
            case STATE_RELEASE:
                ...
                //System.out.println("The activaed sensor is wrist, toucher1, or toucher2: "
                       //+ wrist_force_active + " - " + toucher1_active + " - " + toucher2_active);
                ...
                //System.out.println("monostable_time:" + monostable_time);
