 ...
 * @author Daqi
 */
public abstract class SubsumptionMPT extends FrameworkModuleImpl implements MPTModule{

    private static final Logger logger = Logger
                    .getLogger(SubsumptionMPT.class.getCanonicalName());
    ...
    protected static final int LOWER_INPUT_LEVEL = 0;

    protected static final int HIGHER_INPUT_LEVEL = 1;
     ...
     * Usage: This inner class is supposed to act in the run() method at a concrete
